...
See the `k8s/` directory for manifests. Deploy with:

```bash
kubectl apply -k k8s/
```

See `k8s/README.md` for full documentation on each manifest.
...
This project was built with assistance from Kimi AI (Moonshot AI). The following were AI-generated or AI-assisted:
...
The author can explain and modify every file in this repository.
